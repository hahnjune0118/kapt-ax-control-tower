...
> **분석 범위:** K-APT의 관리비 공개 범위는 공용관리비, 개별사용료, 장기수선충당금 등으로 구성됩니다. 본 프로젝트는 전체 관리비 합계가 아니라 관리주체의 운영 효율성과 직접 관련성이 높은 공용관리비 6개 항목—인건비, 청소비, 경비비, 승강기유지비, 수선비, 시설유지비—만 분석합니다. 개별사용료와 장기수선충당금, 그 밖의 공용관리비 항목은 제외하므로 대시보드 금액은 K-APT의 총 관리비와 일치하지 않습니다. 또한 인건비는 일반관리비 전체가 아닌 급여·제수당·상여금·퇴직급여·사회보험료·복리후생비의 합계이며, 수선비와 시설유지비는 K-APT 수선유지비 계열의 세부 원천항목을 구분한 값입니다.
